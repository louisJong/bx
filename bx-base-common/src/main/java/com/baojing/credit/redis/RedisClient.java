package com.baojing.credit.redis;
...
public class RedisClient {
	...
	static{
		if (pool == null) {
			try{
				...
				pool = new JedisPool(config, ResourceUtils.getValue(PREFIX_CACHE, "redis.server.ip"), Integer.valueOf(ResourceUtils.getValue(PREFIX_CACHE, "redis.server.port"))  , Protocol.DEFAULT_TIMEOUT  , "D_d55%%*))$Ddkj43^2jK");
	...
	public static void main(String[] args) {
		System.out.println(llen("send_gift_13_15"));
	}
}
